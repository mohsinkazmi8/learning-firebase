        ...
        <form onSubmit={handleRegister}>
            <div className="grid grid-cols-5 gap-4">
                <div className='col-span-3 col-start-2'>
                    <h1 className='text-indigo-400 text-4xl font-semibold'>Register</h1>
                </div>
                <div className='col-span-3 col-start-2'>
                ...
                <div className='col-span-3 col-start-2'>
                    <button type='submit' className='bg-indigo-500 text-white rounded px-3 py-2 '>Register</button>
                </div>
            </div>
        </form>
      </div>
